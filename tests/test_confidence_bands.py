...
def test_ingest_one_stores_transformer_row_when_supplied():
    ...
    _ingest_one(
        ...
        NearDuplicateIndex(),
        RunStats(),
        title="A caring headline about people",
        link="https://x.com/a",
        published_utc=None,
        text="people care help harm suffer compassion victim",
        cluster_text="A caring headline",
        min_words=3,
        transformer=tr,
    )
...
def test_no_transformer_row_without_transformer():
    ...
    _ingest_one(
        ...
        NearDuplicateIndex(),
        RunStats(),
        title="Some headline about things",
        link="https://x.com/b",
        published_utc=None,
        text="one two three four five six seven",
        cluster_text="Some headline",
        min_words=3,
    )
...
def test_transformer_failure_does_not_abort_or_half_ingest():
    ...
    _ingest_one(
        ...
        NearDuplicateIndex(),
        stats,
        title="A headline that should still ingest",
        link="https://x.com/c",
        published_utc=None,
        text="care help harm compassion victim suffer people",
        cluster_text="A headline",
        min_words=3,
...
def _store_with_paired_scores():
    ...
    for i, (dic, tr) in enumerate(
        ...
        store.upsert_document(
            ...
            title="t",
            published_utc=None,
            fetched_utc="2026-07-24T00:00:00+00:00",
            word_count=90,
            minhash=None,
        )
        store.upsert_scores(
